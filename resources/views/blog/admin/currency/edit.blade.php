                        ...
                        <div class="box-body">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                       placeholder="Наименование валюты" value="{{$currency->title, old('title')}}"
                                       required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="code" class="form-control" id="title"
                                       placeholder="Код валюты" value="{{$currency->code, old('code')}}" required>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>

                            <div class="form-group">
                                <label for="symbol_left">Символ слева</label>
                                <input type="text" name="symbol_left" class="form-control" id="title"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="symbol_right" class="form-control" id="title"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="value" class="form-control" id="title"
                                       ...
                                       title="если это базовая валюта поставте 1, то курс к базовой валюте." required
                                       data-error="Допускается цифры и десятичная точка" pattern="^[0-9.]{1,}">
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            ...
                            <div class="form-group has-feedback">
                                <label for="value">
                                    <input type="checkbox" name="base"
                                           @if($currency->base) checked @endif>
